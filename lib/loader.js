...
var cleanResources = require('./cleanResources');

var createResources = require('./createResources');

var replaceConfigResources = require('./replaceConfigResources');

var urlRegExp = /^((ht|f)tps?):\/\/([\w\-]+(\.[\w\-]+)*\/)*[\w\-]+(\.[\w\-]+)*\/?(\?([\w\-\.,@?^=%&:\/~\+#]*)+)?/;
var dirname = './dynamic-resource-styles';
...
module.exports.pitch = function () {
  ...
  var resourcesFromConfig = (loaderUtils.getOptions(this) || {}).resources; // networks urls
